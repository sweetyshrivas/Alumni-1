...
import './HomePage.css';
import { FaHandshake, FaDonate, FaBriefcase, FaUsers, FaTrophy, FaCalendarAlt, FaCommentDots } from 'react-icons/fa';
      ...
      <main className="homepage-main">
        ...
        {activeSection === 'networking' && (
          <section className="section-content">
            ...
            <button className="cta-button">Explore Networking</button>
          </section>
        )}
        {activeSection === 'jobs' && (
          <section className="section-content">
        ...
        {activeSection === 'directory' && (
          <section className="section-content">
            ...
            <button className="cta-button">View Directory</button>
          </section>
        )}
        {activeSection === 'success' && (
          <section className="section-content">
            ...
            <button className="cta-button">Read Stories</button>
          </section>
        )}
        ...
        {activeSection === 'feedback' && (
          <section className="section-content">
            ...
            <button className="cta-button">Give Feedback</button>
          </section>
        )}
      </main>
